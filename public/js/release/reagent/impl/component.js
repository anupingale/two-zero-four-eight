...
if((i < len)){
var k = (ks[i]);
var G__5546 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__5547 = (i + (1));
m = G__5546;
i = G__5547;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__5548 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__5548);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__5550 = c;
var G__5550__$1 = (((G__5550 == null))?null:G__5550.prototype);
if((G__5550__$1 == null)){
return null;
} else {
return G__5550__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__5552 = c;
var G__5552__$1 = (((G__5552 == null))?null:G__5552.prototype);
if((G__5552__$1 == null)){
return null;
} else {
return G__5552__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__5556__delegate = function (args){
var G__5554 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__5554) : reagent.impl.component.as_element.call(null,G__5554));
};
var G__5556 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5557__i = 0, G__5557__a = new Array(arguments.length -  0);
while (G__5557__i < G__5557__a.length) {G__5557__a[G__5557__i] = arguments[G__5557__i + 0]; ++G__5557__i;}
  args = new cljs.core.IndexedSeq(G__5557__a,0,null);
} 
return G__5556__delegate.call(this,args);};
G__5556.cljs$lang$maxFixedArity = 0;
G__5556.cljs$lang$applyTo = (function (arglist__5558){
var args = cljs.core.seq(arglist__5558);
...
var _STAR_current_component_STAR__orig_val__5560 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__5561 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__5561);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__5560);
}});
...
var G__5562 = key;
var G__5562__$1 = (((G__5562 instanceof cljs.core.Keyword))?G__5562.fqn:null);
switch (G__5562__$1) {
...
var c = this;
var G__5565_5567 = goog.object.get(c,"cljsRatom");
if((G__5565_5567 == null)){
} else {
reagent.ratom.dispose_BANG_(G__5565_5567);
}
...
var renders_5568 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_5569 = cljs.core.first(cljs.core.vals(renders_5568));
...
if((cljs.core.count(renders_5568) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_5568))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_5569)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_5569], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__5570 = o;
goog.object.set(G__5570,cljs.core.name(k),v);
...
var name = (function (){var G__5571 = fiber;
var G__5571__$1 = (((G__5571 == null))?null:G__5571.type);
if((G__5571__$1 == null)){
return null;
} else {
return G__5571__$1.displayName;
}
})();
var parent = (function (){var G__5572 = fiber;
if((G__5572 == null)){
return null;
} else {
return G__5572.return;
}
})();
var path = (function (){var G__5573 = parent;
var G__5573__$1 = (((G__5573 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__5573) : reagent.impl.component.fiber_component_path.call(null,G__5573)));
if((G__5573__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5573__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__5575 = c;
if((G__5575 == null)){
return null;
} else {
return goog.object.get(G__5575,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__5576._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__5578 = c;
if((G__5578 == null)){
return null;
} else {
return goog.object.get(G__5578,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__5580 = c;
if((G__5580 == null)){
return null;
} else {
return G__5580._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__5582 = instance;
if((G__5582 == null)){
return null;
} else {
return goog.object.get(G__5582,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__5583 = instance;
if((G__5583 == null)){
return null;
} else {
return G__5583._currentElement;
}
}
})();
var name = (function (){var G__5584 = elem;
var G__5584__$1 = (((G__5584 == null))?null:G__5584.type);
if((G__5584__$1 == null)){
return null;
} else {
return G__5584__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__5586 = elem;
if((G__5586 == null)){
return null;
} else {
return goog.object.get(G__5586,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__5587._owner;
}
}
})();
var path = (function (){var G__5588 = owner;
var G__5588__$1 = (((G__5588 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__5588) : reagent.impl.component.component_path.call(null,G__5588)));
if((G__5588__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5588__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__5589 = c;
var G__5589__$1 = (((G__5589 == null))?null:G__5589.constructor);
if((G__5589__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__5589__$1);
}
}
})();
